...
uploaded_files = st.file_uploader("Upload your PDF, CSV, XLSX, or DOC files", type=["pdf", "csv", "xlsx", "doc"], accept_multiple_files=True)

if uploaded_files:
    st.write("You have uploaded:", ", ".join([f.name for f in uploaded_files]))
